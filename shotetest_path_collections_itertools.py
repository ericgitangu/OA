...
class NetworkGraph:
    ...
    Problem Statement:
    Given a network of nodes representing servers and edges representing
    connections between them, simulate the network's behavior using
    collections and itertools. Determine the shortest path between two
    servers.
...
print(
    colored("Shortest path from A to D:", 'green'),
    colored(network('A', 'D'), 'green'),
)  # Output: ['A', 'C', 'D']
# Find and print all possible paths from A to D
print(
    colored("All paths from A to D:", 'red'),
    colored(network.all_paths('A', 'D'), 'green'),
)  # Output: All possible paths from A to D
